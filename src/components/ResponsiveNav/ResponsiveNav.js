...
{
  /* <div className=" h-[150px] w-[40px] lg:hidden relative">
      <div className="absolute  flex  gap-2 bottom-[870px]   h-[70px] ">
        <div className="w-7 h-7 relative  bg-black bg-opacity-40 rounded-[23px] flex items-center justify-center">
          <span className="text-white text-lg font-bold">&lt;</span>
        </div>
        <div>
          <div className="w-[300px] h-7 relative bg-black bg-opacity-40 rounded-[46px]">
            ...
            <div className="left-[8px] top-[7px] absolute justify-start items-center gap-1.5 inline-flex">
              ...
              <div className="text-white text-[9px] font-normal ">
                Search Product
              </div>
            </div>
          </div>
